...
Go to the latest release ([v1.1](https://github.com/Waglayla/waglayla-stratum-bridge/releases/tag/v1.1) at the time of writing) and download the source code. Download the zip archive for windows, tar.gz for everything else.
